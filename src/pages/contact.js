    ...
    return (
      <div>
        <Splash
          ...
          email={this.data.site.siteMetadata.mainEmail}
          alt="Man sitting in with computers in front of him"
        />
        <div {...StyleStandards.marginTop} {...header}>
          <h1 {...noBottomMargin} {...uppercase}>
            Contact Us
          </h1>
          <p>
            Start your journey towards creative freedom by contacting us today.
          ...
          <div {...connectArea}>
            ...
            <div {...mainContactIcons}>
              <FaIcon
                ...
                iconName="phone"
                size="fa-5x"
                style={mainContactIconStyle}
              />
              <FaIcon
                link="mailto:ely@theunfounddoor.com"
                iconName="envelope"
                size="fa-5x"
                style={mainContactIconStyle}
              />
        ...
        <div {...photoArray}>
          <PhotoLink
            to={"/about"}
            fluid={this.data.whoWeArePhoto.childImageSharp.fluid}
            text={"Who We Are"}
