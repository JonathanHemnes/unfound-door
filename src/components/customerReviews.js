...
const CustomerReviews = props => {
  ...
  const reviews = [
    ...
    {
      text:
        "I engaged The Unfound Door to shoot both my professional head-shots and stock imagery for the re-design of my web- site. They went out of their way to make sure we captured all the different types of shots we had originally discussed and displayed their creativity in suggesting various angles and backgrounds for photos. They were great to work with and I appreciated their level of professionalism and positivity.",
      source: "Julie W., Business Rewritten",
    },
    {
      text:
        "Ely and her team are great to work with! We have used them a few times to shoot various construction projects and have received quality images with quick turn-around. Ely and her team take care to make sure we get the shots that not only help us but also our clients!",
      source: "Jessica N., Pinkard Construction",
    },
    {
      text:
        "They are so amazing to work with! Totally made me feel like a movie star for a morning, and the head shots turned out amazing.",
      source: "Conor R.",
    },
  ]
