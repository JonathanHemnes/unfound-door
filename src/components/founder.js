...
const Founder = props => (
  <div {...container}>
    <div {...header}>
      <h1>CEO & FOUNDER</h1>
      <p>
        CEO of THE<strong>UNFOUND</strong>DOOR and Account Manager of client
        projects, Ely Hemnes is our client’s primary contact for communication,
        organization, and logistical support. Her skills include building
        top-notch teams, constructing frameworks for artistic professionals,
        aiding clients in curating vision, internal & external strategy,
        translating client’s vision to technical staff, and managing timelines.
        Ely is also the quality assurance to assess product before delivery to
        client.
      </p>
    </div>
    <div {...photos}>
      <div {...leftPhotoStyle}>
        <Img fluid={props.img.fluid} />
      </div>
      <div {...rightPhotoStyle}>
